...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 17, 2017 at 09:24 PM
...
('root', '[{\"db\":\"eventtracker\",\"table\":\"event\"},{\"db\":\"eventtracker\",\"table\":\"rso_event\"},{\"db\":\"eventtracker\",\"table\":\"location\"},{\"db\":\"eventtracker\",\"table\":\"rso_comment\"},{\"db\":\"eventtracker\",\"table\":\"comment\"},{\"db\":\"eventtracker\",\"table\":\"roster\"},{\"db\":\"eventtracker\",\"table\":\"user\"},{\"db\":\"eventtracker\",\"table\":\"rso\"},{\"db\":\"eventtracker\",\"table\":\"university\"},{\"db\":\"eventtracker\",\"table\":\"super_admin\"}]');
...
('root', 'eventtracker', 'location', '{\"sorted_col\":\"`location_id` ASC\"}', '2017-07-16 20:17:48'),
('root', 'eventtracker', 'roster', '{\"sorted_col\":\"`roster`.`rso_id`  ASC\"}', '2017-07-13 18:34:54'),
('root', 'eventtracker', 'university', '{\"sorted_col\":\"`university`.`univ_id`  ASC\"}', '2017-07-10 23:29:23');
...
('root', '2017-06-29 12:21:11', '{\"collation_connection\":\"utf8mb4_unicode_ci\"}');
